...
const seedAgents = [
  ...
  },
  {
    ...
    phone: '+995 577 234 567', email: 'nino@tbilisirealtor.ge',
    ...
    company: 'TbilisiRealtor.GE', verified: true, languages: ['ქართული', 'ინგლისური'], isActive: true,
  },
  {
  ...
  },
  {
    ...
    phone: '+995 598 456 789', email: 'mariam@tbilisirealtor.ge',
    ...
    company: 'TbilisiRealtor.GE', verified: true, languages: ['ქართული', 'ინგლისური', 'ფრანგული'], isActive: true,
  },
  {
    id: 'a5', name: 'დავით ჩიქოვანი', photo: AGENT_PHOTOS[4],
    phone: '+995 591 567 890', email: 'davit@tbilisirealtor.ge',
  ...
  },
  {
    ...
    phone: '+995 593 678 901', email: 'ana@tbilisirealtor.ge',
    ...
    company: 'TbilisiRealtor.GE', verified: false, languages: ['ქართული', 'ინგლისური', 'თურქული'], isActive: true,
  },
];

const seedProperties = [
  { id:'p1', title:'ლუქსუსური პენტჰაუსი მთის ხედით', price:'850000', pricePerSqm:'3400', address:'ვაშლოვანის ქუჩა 12, მე-15 სართული', city:'თბილისი', district:'ვაკე', type:'apartment', status:'sale', bedrooms:4, bathrooms:3, area:'250', floor:15, totalFloors:15, yearBuilt:2023, images:[PROPERTY_IMAGES.luxury1, PROPERTY_IMAGES.luxury2, PROPERTY_IMAGES.interior1, PROPERTY_IMAGES.interior2, PROPERTY_IMAGES.interior3], amenities:['კონდიციონერი','ლიფტი','პარკინგი','დაცვა 24/7','სპა','სპოტ-დარბაზი','ბასეინი','ტერასა'], features:['სმარტ-ჰოუს','პანორამული ხედი'], agentId:'a1', agentName:'გიორგი ბერიძე', agentPhone:'+995 599 123 456', agentEmail:'giorgi@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:1247, listedDate:'2026-06-15', coordinates:{lat:41.6941,lng:44.8337}, description:'განსაკუთრებული პენტჰაუსი ვაკეში, საიდანაც იხსნება მთის და ქალაქის პანორამული ხედები.' },
  { id:'p2', title:'ელეგანტური ვილა ნუცუბიძეზე', price:'650000', pricePerSqm:'2600', address:'ნუცუბიძის ქ. 45', city:'თბილისი', district:'ნუცუბიძე', type:'villa', status:'sale', bedrooms:5, bathrooms:4, area:'250', yearBuilt:2022, images:[PROPERTY_IMAGES.luxury4, PROPERTY_IMAGES.luxury5, PROPERTY_IMAGES.luxury6, PROPERTY_IMAGES.interior1], amenities:['კერძო ბაღი','ბასეინი','ბარბეკიუ','გარაჟი'], features:['ორი სართული','ქვის ფასადი'], agentId:'a2', agentName:'ნინო კვარაცხელია', agentPhone:'+995 577 234 567', agentEmail:'nino@tbilisirealtor.ge', isFeatured:true, isNew:false, isPremium:true, viewCount:892, listedDate:'2026-05-20', coordinates:{lat:41.7200,lng:44.7900}, description:'მშვენიერი ვილა ნუცუბიძის პლატოზე.' },
  { id:'p3', title:'მოდერნული ბინა ვარკეთილში', price:'95000', pricePerSqm:'1450', address:'ვარკეთილი 3, კვ. 4, ბლოკი B', city:'თბილისი', district:'ვარკეთილი', type:'apartment', status:'sale', bedrooms:3, bathrooms:1, area:'65', floor:7, totalFloors:12, yearBuilt:2020, images:[PROPERTY_IMAGES.apt1, PROPERTY_IMAGES.apt2, PROPERTY_IMAGES.interior2], amenities:['ლიფტი','კონდიციონერი','ეზო'], features:['ევრო-განახლება','სრული ავეჯი'], agentId:'a3', agentName:'ლაშა მამულაშვილი', agentPhone:'+995 595 345 678', agentEmail:'lasha@tbilisirealtor.ge', isFeatured:false, isNew:true, isPremium:false, viewCount:456, listedDate:'2026-06-28', coordinates:{lat:41.7350,lng:44.8100}, description:'ახლად გარემონტებული 3-ოთახიანი ბინა ვარკეთილის ახალ კომპლექსში.' },
  { id:'p4', title:'საოფისე სივრცე გლდანში', price:'2500', pricePerSqm:'25', address:'გლდანის გამზირი 14', city:'თბილისი', district:'გლდანი', type:'commercial', status:'rent', bedrooms:0, bathrooms:2, area:'100', floor:3, totalFloors:8, yearBuilt:2019, images:[PROPERTY_IMAGES.apt3, PROPERTY_IMAGES.interior3, PROPERTY_IMAGES.luxury3], amenities:['პარკინგი','ინტერნეტი','გათბობა','კონდიციონერი'], features:['ღია სივრცე','კონფ.-ოთახი'], agentId:'a3', agentName:'ლაშა მამულაშვილი', agentPhone:'+995 595 345 678', agentEmail:'lasha@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:234, listedDate:'2026-06-01', coordinates:{lat:41.7500,lng:44.8200}, description:'კომფორტული საოფისე სივრცე გლდანის ბიზნეს ცენტრში.' },
  { id:'p5', title:'ბრწყინვალე ბინა ძველ თბილისში', price:'320000', pricePerSqm:'3200', address:'ლეღვთახევის ქ. 8', city:'თბილისი', district:'ძველი თბილისი', type:'apartment', status:'sale', bedrooms:2, bathrooms:2, area:'100', floor:2, totalFloors:3, yearBuilt:1920, images:[PROPERTY_IMAGES.luxury7, PROPERTY_IMAGES.luxury8, PROPERTY_IMAGES.interior1, PROPERTY_IMAGES.interior2], amenities:['ტერასა','ეზო','სარდაფი'], features:['ისტორიული ფასადი','ხის ჭერი','კამინი'], agentId:'a4', agentName:'მარიამ გელაშვილი', agentPhone:'+995 598 456 789', agentEmail:'mariam@tbilisirealtor.ge', isFeatured:true, isNew:false, isPremium:true, viewCount:1089, listedDate:'2026-04-10', coordinates:{lat:41.6890,lng:44.8100}, description:'ისტორიული ძველი თბილისის გულში მდებარე ანტიკური ბინა.' },
  { id:'p6', title:'ახალი აპარტამენტი საბურთალოზე', price:'1800', pricePerSqm:'30', address:'ქავთარაძის ქ. 22, ბლოკი C', city:'თბილისი', district:'საბურთალო', type:'apartment', status:'rent', bedrooms:2, bathrooms:1, area:'60', floor:5, totalFloors:10, yearBuilt:2021, images:[PROPERTY_IMAGES.apt2, PROPERTY_IMAGES.apt3, PROPERTY_IMAGES.interior3], amenities:['ლიფტი','კონდიციონერი','პარკინგი'], features:['ახალი ავეჯი','ნათელი ოთახები'], agentId:'a5', agentName:'დავით ჩიქოვანი', agentPhone:'+995 591 567 890', agentEmail:'davit@tbilisirealtor.ge', isFeatured:false, isNew:true, isPremium:false, viewCount:321, listedDate:'2026-06-30', coordinates:{lat:41.7150,lng:44.7700}, description:'ახალ კომპლექსში განახლებული 2-ოთახიანი ბინა.' },
  { id:'p7', title:'სახელმწიფო სახლი მთაწმინდაზე', price:'1200000', pricePerSqm:'4000', address:'მთაწმინდა, ქ. კოტე', city:'თბილისი', district:'მთაწმინდა', type:'house', status:'sale', bedrooms:6, bathrooms:5, area:'300', yearBuilt:2024, images:[PROPERTY_IMAGES.luxury5, PROPERTY_IMAGES.luxury6, PROPERTY_IMAGES.luxury7, PROPERTY_IMAGES.interior1, PROPERTY_IMAGES.interior2], amenities:['ბასეინი','სპა','ფიტნეს','ბაღი','გარაჟი','დაცვა'], features:['პანორამული ხედი','სმარტ-ჰოუს','3 სართული'], agentId:'a1', agentName:'გიორგი ბერიძე', agentPhone:'+995 599 123 456', agentEmail:'giorgi@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:2341, listedDate:'2026-06-01', coordinates:{lat:41.6960,lng:44.7980}, description:'ექსკლუზიური სახლი მთაწმინდის კალთაზე.' },
  { id:'p8', title:'ბინა ისანში - ბაღის ხედით', price:'55000', pricePerSqm:'1100', address:'ისნის გამზ. 5', city:'თბილისი', district:'ისანი', type:'apartment', status:'sale', bedrooms:1, bathrooms:1, area:'50', floor:3, totalFloors:9, yearBuilt:2022, images:[PROPERTY_IMAGES.apt1, PROPERTY_IMAGES.apt3, PROPERTY_IMAGES.interior3], amenities:['ლიფტი','ეზო','ბავშვთა მოედანი'], features:['კომფორტული განლაგება','ნათელი'], agentId:'a6', agentName:'ანა ლომიძე', agentPhone:'+995 593 678 901', agentEmail:'ana@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:178, listedDate:'2026-05-15', coordinates:{lat:41.6800,lng:44.8500}, description:'კომფორტული 1-ოთახიანი ბინა ისნის ახალ კომპლექსში.' },
  { id:'p9', title:'ლუქს-ოფისი ვაკეში', price:'8000', pricePerSqm:'40', address:'ჭავჭავაძის გამზ. 70', city:'თბილისი', district:'ვაკე', type:'commercial', status:'rent', bedrooms:0, bathrooms:4, area:'200', floor:10, totalFloors:15, yearBuilt:2023, images:[PROPERTY_IMAGES.luxury3, PROPERTY_IMAGES.interior2, PROPERTY_IMAGES.interior3], amenities:['A-კლასი','პარკინგი','ინტერნეტი','გათბობა','დაცვა'], features:['ღია სივრცე','კონფ.-ოთახი','კუხნია'], agentId:'a3', agentName:'ლაშა მამულაშვილი', agentPhone:'+995 595 345 678', agentEmail:'lasha@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:true, viewCount:567, listedDate:'2026-03-20', coordinates:{lat:41.7100,lng:44.7800}, description:'A-კლასის საოფისე სივრცე ვაკის ბიზნეს ცენტრში.' },
  { id:'p10', title:'კოტეჯი მცხეთაში', price:'280000', pricePerSqm:'1400', address:'მცხეთა, კახეთის გზ. 3', city:'მცხეთა', district:'ცენტრი', type:'house', status:'sale', bedrooms:4, bathrooms:3, area:'200', yearBuilt:2021, images:[PROPERTY_IMAGES.luxury8, PROPERTY_IMAGES.luxury4, PROPERTY_IMAGES.interior1], amenities:['ბაღი','მარანი','ბარბეკიუ','გარაჟი'], features:['ქვის ფასადი','ხის ჭერი','ღვინის სარდაფი'], agentId:'a6', agentName:'ანა ლომიძე', agentPhone:'+995 593 678 901', agentEmail:'ana@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:432, listedDate:'2026-04-25', coordinates:{lat:41.8460,lng:44.7190}, description:'ულამაზესი კოტეჯი ისტორიულ მცხეთაში.' },
  { id:'p11', title:'ახალი ბინა ბათუმში - ზღვის ხედი', price:'195000', pricePerSqm:'2600', address:'ნინოშვილის ქ. 2, Sea Towers', city:'ბათუმი', district:'ცენტრი', type:'apartment', status:'sale', bedrooms:2, bathrooms:2, area:'75', floor:18, totalFloors:25, yearBuilt:2024, images:[PROPERTY_IMAGES.luxury2, PROPERTY_IMAGES.luxury5, PROPERTY_IMAGES.interior2, PROPERTY_IMAGES.interior3], amenities:['ბასეინი','სპა','ფიტნეს','კონსიერჟი','პარკინგი'], features:['ზღვის ხედი','სმარტ-ჰოუს'], agentId:'a4', agentName:'მარიამ გელაშვილი', agentPhone:'+995 598 456 789', agentEmail:'mariam@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:1678, listedDate:'2026-07-01', coordinates:{lat:41.6168,lng:41.6367}, description:'ბათუმის ყველაზე მოთხოვნად ლოკაციაზე ახალი ბინა.' },
  { id:'p12', title:'სასოფლო სახლი კახეთში', price:'120000', pricePerSqm:'800', address:'სიღნაღი, ბოდბის ქ. 5', city:'სიღნაღი', district:'ცენტრი', type:'house', status:'sale', bedrooms:3, bathrooms:2, area:'150', yearBuilt:2018, images:[PROPERTY_IMAGES.luxury6, PROPERTY_IMAGES.luxury7, PROPERTY_IMAGES.interior1], amenities:['ვენახი','ბაღი','მარანი'], features:['ქართული სტილი','ვენახი'], agentId:'a6', agentName:'ანა ლომიძე', agentPhone:'+995 593 678 901', agentEmail:'ana@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:289, listedDate:'2026-05-01', coordinates:{lat:41.6224,lng:45.9219}, description:'ტრადიციული ქართული სახლი კახეთის მხარეში.' },
  { id:'p13', title:'Studio Vake - New', price:'78000', pricePerSqm:'1950', address:'Chavchavadze 55', city:'თბილისი', district:'ვაკე', type:'apartment', status:'sale', bedrooms:1, bathrooms:1, area:'40', floor:6, totalFloors:12, yearBuilt:2024, images:[PROPERTY_IMAGES.apt1], amenities:['ლიფტი','კონდ.'], features:['Furnished','New'], agentId:'a1', agentName:'გიორგი ბერიძე', agentPhone:'+995 599 123 456', agentEmail:'giorgi@tbilisirealtor.ge', isFeatured:false, isNew:true, isPremium:false, viewCount:312, listedDate:'2026-07-01', coordinates:{lat:41.708,lng:44.773}, description:'Comfortable studio in Vake. Euro-renovation, furnished.' },
  { id:'p14', title:'5-room Penthouse Saburtalo', price:'420000', pricePerSqm:'2800', address:'Svanetis 1, Sapphire', city:'თბილისი', district:'საბურთალო', type:'apartment', status:'sale', bedrooms:5, bathrooms:3, area:'150', floor:14, totalFloors:18, yearBuilt:2023, images:[PROPERTY_IMAGES.luxury5], amenities:['Pool','Spa','Fitness','Parking'], features:['2 Terraces','Panorama'], agentId:'a4', agentName:'მარიამ გელაშვილი', agentPhone:'+995 598 456 789', agentEmail:'mariam@tbilisirealtor.ge', isFeatured:true, isNew:false, isPremium:true, viewCount:876, listedDate:'2026-05-10', coordinates:{lat:41.718,lng:44.769}, description:'Spacious 5-room in new elite complex.' },
  { id:'p15', title:'Apartment Nadzaladevi New Complex', price:'65000', pricePerSqm:'1300', address:'Nikoladze 25', city:'თბილისი', district:'ნაძალადევი', type:'apartment', status:'sale', bedrooms:2, bathrooms:1, area:'50', floor:4, totalFloors:10, yearBuilt:2021, images:[PROPERTY_IMAGES.apt3], amenities:['Lift','Yard'], features:['New Complex'], agentId:'a5', agentName:'დავით ჩიქოვანი', agentPhone:'+995 591 567 890', agentEmail:'davit@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:198, listedDate:'2026-04-15', coordinates:{lat:41.742,lng:44.826}, description:'2-room apartment in new complex.' },
  { id:'p16', title:'Batumi Central New Complex', price:'155000', pricePerSqm:'2067', address:'Ninoshvili 15', city:'ბათუმი', district:'ცენტრი', type:'apartment', status:'sale', bedrooms:3, bathrooms:2, area:'75', floor:8, totalFloors:20, yearBuilt:2023, images:[PROPERTY_IMAGES.luxury7], amenities:['Pool','Concierge','Parking'], features:['Sea view','New'], agentId:'a4', agentName:'მარიამ გელაშვილი', agentPhone:'+995 598 456 789', agentEmail:'mariam@tbilisirealtor.ge', isFeatured:false, isNew:true, isPremium:false, viewCount:543, listedDate:'2026-06-20', coordinates:{lat:41.640,lng:41.643}, description:'3-room flat, 200m to sea. New complex.' },
  { id:'p17', title:'Luxury Villa Bodbe Winery', price:'380000', pricePerSqm:'1900', address:'Bodbe', city:'სიღნაღი', district:'ბოდბე', type:'villa', status:'sale', bedrooms:4, bathrooms:3, area:'200', yearBuilt:2020, images:[PROPERTY_IMAGES.luxury8], amenities:['Vineyard','Garden','Winery'], features:['Stone facade','Wine cellar'], agentId:'a6', agentName:'ანა ლომიძე', agentPhone:'+995 593 678 901', agentEmail:'ana@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:true, viewCount:234, listedDate:'2026-03-10', coordinates:{lat:41.604,lng:45.900}, description:'Exclusive villa near Bodbe. Vineyard, garden, wine cellar.' },
  { id:'p18', title:'A++ Office Space Vake', price:'12000', pricePerSqm:'48', address:'Chavchavadze 80', city:'თბილისი', district:'ვაკე', type:'commercial', status:'rent', bedrooms:0, bathrooms:4, area:'250', floor:12, totalFloors:20, yearBuilt:2024, images:[PROPERTY_IMAGES.interior1], amenities:['VIP Parking','24/7 Security'], features:['Smart office','Panoramic view'], agentId:'a3', agentName:'ლაშა მამულაშვილი', agentPhone:'+995 595 345 678', agentEmail:'lasha@tbilisirealtor.ge', isFeatured:false, isNew:true, isPremium:true, viewCount:412, listedDate:'2026-07-02', coordinates:{lat:41.710,lng:44.779}, description:'Class-A office in Vake Business Center.' },
  { id:'p19', title:'4-room Isani Modern Flat', price:'2200', pricePerSqm:'28.6', address:'Isnis 12', city:'თბილისი', district:'ისანი', type:'apartment', status:'rent', bedrooms:4, bathrooms:2, area:'77', floor:9, totalFloors:14, yearBuilt:2022, images:[PROPERTY_IMAGES.apt2], amenities:['Lift','AC','Parking'], features:['Wide balcony','Renovated'], agentId:'a6', agentName:'ანა ლომიძე', agentPhone:'+995 593 678 901', agentEmail:'ana@tbilisirealtor.ge', isFeatured:false, isNew:false, isPremium:false, viewCount:156, listedDate:'2026-06-12', coordinates:{lat:41.682,lng:44.848}, description:'Modern 4-room in new Isani quarter.' },
  { id:'p20', title:'Elite Villa Tbilisi Sea Pool', price:'950000', pricePerSqm:'3800', address:'Tbilisi Sea Villas', city:'თბილისი', district:'თბილისის ზღვა', type:'villa', status:'sale', bedrooms:5, bathrooms:4, area:'250', yearBuilt:2023, images:[PROPERTY_IMAGES.luxury4], amenities:['Pool','Spa','Garage','Garden','Security'], features:['3 floors','Smart home'], agentId:'a1', agentName:'გიორგი ბერიძე', agentPhone:'+995 599 123 456', agentEmail:'giorgi@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:1893, listedDate:'2026-07-03', coordinates:{lat:41.789,lng:44.842}, description:'Exceptional villa at Tbilisi Sea.' },
  { id:'p21', title:'პენტჰაუსი ბათუმში — ზღვის პანორამა', price:'720000', pricePerSqm:'4800', address:'ბარათაშვილის ქ. 1, Orbi Beach Tower', city:'ბათუმი', district:'ბულვარი', type:'apartment', status:'sale', bedrooms:3, bathrooms:3, area:'150', floor:28, totalFloors:30, yearBuilt:2024, images:[PROPERTY_IMAGES.luxury2, PROPERTY_IMAGES.interior2], amenities:['კონსიერჟი','ბასეინი','სპა','ფიტნეს','პარკინგი'], features:['270° ზღვის ხედი','სმარტ-ჰოუს'], agentId:'a4', agentName:'მარიამ გელაშვილი', agentPhone:'+995 598 456 789', agentEmail:'mariam@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:2104, listedDate:'2026-07-05', coordinates:{lat:41.6410,lng:41.6380}, description:'ბათუმის ყველაზე მაღლა მდებარე ლუქს-პენტჰაუსი.' },
  { id:'p22', title:'ექსკლუზიური ვილა — ვაკის ბაღნარი', price:'1450000', pricePerSqm:'4143', address:'ჭოველიძის ჩიხი 7', city:'თბილისი', district:'ვაკე', type:'villa', status:'sale', bedrooms:4, bathrooms:4, area:'350', yearBuilt:2024, images:[PROPERTY_IMAGES.luxury6, PROPERTY_IMAGES.luxury5], amenities:['კერძო ბასეინი','ბაღი','გარაჟი','სმარტ-ჰოუს'], features:['ლანდ-დიზაინი','კინო-დარბაზი'], agentId:'a2', agentName:'ნინო კვარაცხელია', agentPhone:'+995 577 234 567', agentEmail:'nino@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:1742, listedDate:'2026-07-06', coordinates:{lat:41.7080,lng:44.7760}, description:'ვაკის ყველაზე კულტიურ უბანში.' },
  { id:'p23', title:'სტუდია — რუსთაველის ბულვარი', price:'185000', pricePerSqm:'4625', address:'რუსთაველის გამზ. 42', city:'თბილისი', district:'ცენტრი', type:'apartment', status:'sale', bedrooms:1, bathrooms:1, area:'40', floor:12, totalFloors:14, yearBuilt:2023, images:[PROPERTY_IMAGES.apt1, PROPERTY_IMAGES.interior1], amenities:['ლიფტი','კონდ.','კონსიერჟი'], features:['ბულვარის ხედი','ავეჯით'], agentId:'a1', agentName:'გიორგი ბერიძე', agentPhone:'+995 599 123 456', agentEmail:'giorgi@tbilisirealtor.ge', isFeatured:true, isNew:false, isPremium:true, viewCount:1385, listedDate:'2026-06-18', coordinates:{lat:41.6960,lng:44.8010}, description:'უნიკალური სტუდიო რუსთაველის ბულვარზე.' },
  { id:'p24', title:'ლუქს-ოთახი ქუთაისში', price:'98000', pricePerSqm:'1960', address:'წერეთლის გამზ. 118', city:'ქუთაისი', district:'ცენტრი', type:'apartment', status:'sale', bedrooms:2, bathrooms:1, area:'50', floor:6, totalFloors:12, yearBuilt:2023, images:[PROPERTY_IMAGES.apt2, PROPERTY_IMAGES.apt3], amenities:['ლიფტი','ეზო','პარკინგი'], features:['ახალი კომპლ.','ევრო-განახლება'], agentId:'a5', agentName:'დავით ჩიქოვანი', agentPhone:'+995 591 567 890', agentEmail:'davit@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:876, listedDate:'2026-07-07', coordinates:{lat:42.2690,lng:42.6960}, description:'ქუთაისის პრემიუმ-სეგმენტის სიახლე.' },
  { id:'p25', title:'VIP კომერციული — ჭავჭავაძის 62', price:'18500', pricePerSqm:'37', address:'ჭავჭავაძის გამზ. 62', city:'თბილისი', district:'ვაკე', type:'commercial', status:'rent', bedrooms:0, bathrooms:5, area:'500', floor:3, totalFloors:3, yearBuilt:2024, images:[PROPERTY_IMAGES.luxury3, PROPERTY_IMAGES.interior2], amenities:['VIP პარკინგი','A/C','ინტ. 1GB'], features:['3 ეტაჟი','ტერასა'], agentId:'a3', agentName:'ლაშა მამულაშვილი', agentPhone:'+995 595 345 678', agentEmail:'lasha@tbilisirealtor.ge', isFeatured:true, isNew:true, isPremium:true, viewCount:1021, listedDate:'2026-07-08', coordinates:{lat:41.7120,lng:44.7800}, description:'A++ კლასის საოფისე კომპლექსი ვაკის ბიზნეს-ჰაბში.' },
];
